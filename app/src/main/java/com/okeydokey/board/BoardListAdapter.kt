...
data class Board(val no: Int, val category: Category, val title: String, val content: String, val register: String, val registered: String, val image: String)
...
class BoardListAdapter(private val mContext: Context) : BaseAdapter() {
